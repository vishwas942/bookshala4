...
const Signup = () => {
  ...
  const [credentials, setcredentials] = useState({Name:"", Email:"", password:"", Confirmpassword:"", DOB:"" })
  ...
  <div className="mb-3">
    <label htmlFor="Confirmpassword" className="form-label">Date of Birth</label>
    <input type="text" onChange={onChange} placeholder='DD-MM-YYYY' name='DOB' className="form-control" id="DOB"/>
  </div>
